...
#pragma region TestParseHandler
	...
	*/
	bool TestParseHandler::Start(const std::string& key, Json::Value& object, IWrapper* wrapper, bool isArray)
	{
	 ...
	 * @return True, if handled, false otherwise
	*/
	bool TestParseHandler::End(Json::Value& object, IWrapper* wrapper, const std::string&) {
